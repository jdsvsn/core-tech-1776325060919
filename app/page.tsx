...
const basePath = '/core-tech-1776325060919';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our Hosting services provide secure, reliable, and high-performance hosting solutions for businesses of all sizes, ensuring that your online presence is always available and optimized for maximum visibility. With flexible plans and expert support, we help you find the perfect hosting solution for your unique needs.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our Web Dev services offer custom web development solutions designed to drive business growth and enhance your online presence. From simple websites to complex web applications, our team of experts will work closely with you to bring your vision to life.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our App Dev services provide bespoke mobile and web application development solutions, crafted to meet the specific needs of your business and enhance your customers\' experience. With a focus on innovation and usability, we help you create engaging and effective applications that drive results.', i: 'https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our Domain registration services provide a simple and convenient way to manage your online identity, offering a wide range of domain extensions and expert guidance to help you find the perfect domain for your business. With secure and reliable domain management, you can focus on growing your online presence with confidence.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our Inquiries service provides a dedicated point of contact for all your technology-related questions and concerns, offering expert advice and guidance to help you navigate the complex world of technology and make informed decisions about your business.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing cutting-edge technology solutions to empower businesses in Kuching and beyond. With a strong focus on innovation and customer satisfaction, our team of experts strives to deliver high-quality services that exceed our clients\' expectations. By leveraging the latest technologies and trends, we aim to make a meaningful impact in the tech industry.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading technology solutions provider in Kuching, recognized for our exceptional service and innovative approach.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver tailored technology solutions that meet the unique needs of our clients, fostering long-term partnerships and driving business growth through innovation and expertise.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">Our \'Customer First\' core value reflects our commitment to prioritizing the needs and satisfaction of our clients, ensuring that every solution we provide is tailored to their specific requirements and goals.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">Our \'Innovation\' core value represents our dedication to staying at the forefront of technological advancements, continuously updating our knowledge and expertise to provide our clients with the most effective and efficient solutions available.</p>
                </div>
              </div>
            </div>
